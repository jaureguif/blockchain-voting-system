...
public class AssetController {
  ...
  public Asset postAsset(@RequestPart("file") MultipartFile file, AssetDTO dto,
    ...
    String businessProviderName = businesProviderRepository.findByUsername(request.getUserPrincipal().getName()).get().getName();
    this.validate(dto);
  ...
  public Asset newAssetEvent(
    ...
    return api.addEventToAsset(id, event);
  }

  private void validate(AssetDTO asset) throws NoSuchMethodException, SecurityException, MethodArgumentNotValidException {
