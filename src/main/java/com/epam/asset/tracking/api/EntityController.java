...
public class EntityController {
  ...
  private MapperFacade mapper;
	...
	@ApiOperation(value = "Posting a new, unique, business provider into DB", notes = "Current validations are:"
			+ "<br>" + "Not allowed numbers or symbols (space is not allowed): <b>username</b>" + "<br>"
			+ "Not allowed numbers or symbols (space is allowed): <b>name</b>, <b>lastname</b>, <b>city</b> & <b>state</b>"
			+ "<br>" + "Not allowed symbols (space, comma and periods are allowed): <b>address</b>" + "<br>"
	...
	public void postEntity(@ApiParam(value = "Posting a new Bussiness Provider. <br><br>"
			+ "Username nust be unique, otherwize application will return a 409 status code. <br><br>"
			+ "Business Type is validated against allowed values (listed in implementation notes)", required = true) @RequestBody @Valid EntityDTO entity) {
